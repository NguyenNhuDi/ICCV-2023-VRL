...
def main(folder:str):
    ...
    log_paths = glob.glob(f'/home/andrewheschl/Documents/3DSegmentation/logs/{folder}/**/*.txt', recursive=True)
    ...
    workbook = xlsx.Workbook(f'/home/andrewheschl/Documents/3DSegmentation/logs/Result/{folder}_logs.xlsx')
