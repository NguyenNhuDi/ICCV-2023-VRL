...
class ModelGenerator:
    def __init__(self, json_path:str) -> None:
        ...
        self.__buildarchitecture__()

    def __buildarchitecture__(self) -> None:
        """
        ...
        if "Encoder" in model_definition.keys():
            ...
            model_definition = self.__convert_unetlike_to_normal__(model_definition)
        else:
    ...
    def __convert_unetlike_to_normal__(self, model_definition:dict)->dict:
        encoder_elements = []
        middle_elements = []
        decoder_elements =[]
    ...
    def verify_structure(model_definition:dict)->bool:
        ...
        ModelGenerator.__validatenode__(keys)
        ...
        if not 'Tag' in keys and not 'ComponentClass' in keys:
    ...
    @staticmethod
    def __validatenode__(keys:list)->bool:
        """
