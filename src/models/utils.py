...
from src.models.constant import CONCAT, ADD
...
class XModule(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, dilations=[1], kernel_sizes=[3], mode='concat', stride=1, apply_norm:bool=False, **kwargs):
...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, out_channels, conv_op:str, kernel_size=3, dilation=1, last_layer:bool=False, pad="default") -> None:
        super().__init__()
